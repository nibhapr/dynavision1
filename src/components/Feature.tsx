...
const Feature = ({
	...
	return (
		<>
			<div className="flex flex-col relative cursor-pointer text-black">
				<motion.div
				...
				<motion.div
					...
					className="border-2 border-gray-400 w-full h-full bg-lime-300  rounded-lg p-4 relative flex justify-between"
				>
					<p>{body}</p>
